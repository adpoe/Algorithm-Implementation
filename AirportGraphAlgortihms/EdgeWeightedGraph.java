...
public class EdgeWeightedGraph {
    ...
    public SeparateChainingHashST<Integer, String> cityNameIndex;
    ...
    public EdgeWeightedGraph(int V) {
        ...
        this.cityNameIndex = new SeparateChainingHashST<Integer, String>();
    }
    ...
    public EdgeWeightedGraph(int V, int E) {
        ...
        for (int i = 0; i < E; i++) {
            ...
            double miles = Math.round(100 * StdRandom.uniform()) / 100.0;
            double cost = Math.round(100 * StdRandom.uniform()) / 100.0;
            String srcCityName = "";
            String dstCityName = "";
            Edge e = new Edge(v, w, miles, cost, srcCityName, dstCityName);
            addEdge(e);
        }
        this.cityNameIndex = new SeparateChainingHashST<Integer, String>();
    }
    ...
    public EdgeWeightedGraph(In in) {
        ...
        for (int i = 0; i < E; i++) {
            ...
            String srcCityName = in.readString();
            String dstCityName = in.readString();
            Edge e = new Edge(v, w, miles, cost, srcCityName, dstCityName);
            addEdge(e);
        }
    }
    ...
    public void addEdge(Edge e) {
        ...
        adj[w].add(e);
        E++;
        cityNameIndex.put(e.getV(), e.getSourceCityName());
        cityNameIndex.put(e.getW(), e.getDstCityName());
    }
    ...
    public String toString() {
        ...
        for (int v = 1; v < V; v++) {
           // s.append(v + ": ");
            s.append("Flights TO/FROM " + this.cityNameIndex.get(v)+ ": \n\t");
            for (Edge e : adj[v]) {
                s.append(e + "  ");
                s.append("\n\t");
            }
    ...
    public void initalizeCostCompare(){
        for (Bag<Edge> e : adj) {
